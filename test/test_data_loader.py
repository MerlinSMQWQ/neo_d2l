...
from ..src.utils.data_loader import load_array, get_fashion_mnist_labels, get_dataloader_workers
from ..src.utils.display import save_images
...
def test_fashion_mnist():
    ...
    save_images(X.reshape(18, 28, 28), 2, 9, titles=get_fashion_mnist_labels(y), output_png_path= r'./lab_img/output2.png');
    
    
def test_get_dataloader_workers():
